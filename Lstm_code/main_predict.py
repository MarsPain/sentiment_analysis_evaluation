...
import math
import random
from Lstm_code.data_utils import seg_words, get_vector_tfidf
from Lstm_code.utils import load_data_from_csv, load_tfidf_dict,\
    load_word_embedding
from Lstm_code.model import Bilstm
...
tfidf_path = "data/tfidf_3.txt"
word2vec_model_path = "data/word2vec_char_model_sg.txt"
